...
public class ForwardedProjectEventHandler {
  ...
  @Inject
  public ForwardedProjectEventHandler(
      OneOffRequestContext oneOffCtx, ChangeIndexCollection indexes) {
    this.oneOffCtx = oneOffCtx;
    this.indexes = indexes;
  }

  /**
   * Handles {@link AllProjectChangesDeletedFromIndexEvent} events by deleting all project changes
   * from the index
   *
   * @param event the event to handle
   */
  public void handleAllProjectChangesDeletedFromIndexEvent(
      AllProjectChangesDeletedFromIndexEvent event) {
