...
public class KeyWrapperAdapter implements JsonSerializer<Object>, JsonDeserializer<Object> {
  ...
  private static final ImmutableMap<String, Class<?>> registeredKeyTypes = CacheKeyType.getRegisteredKeys();
  ...
  public JsonElement serialize(Object key, Type typeOfSrc, JsonSerializationContext context) {
    if (key instanceof String || key instanceof Number) {
      ...
      Optional<String> keyType = getEventTypeKeyByValue(key.getClass());
  ...
  public Object deserialize(JsonElement json, Type type, JsonDeserializationContext context)
    ...
    if (json.isJsonObject()) {
      ...
      Class<?> cls = registeredKeyTypes.get(typeName);
      if (cls == null) {
  ...
  public static Optional<String> getEventTypeKeyByValue(Class<?> value) {
         return registeredKeyTypes.entrySet().stream()
