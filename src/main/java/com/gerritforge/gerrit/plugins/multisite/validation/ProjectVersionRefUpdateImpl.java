...
public class ProjectVersionRefUpdateImpl
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.multisite.validation.ProjectVersionRefUpdate#getProjectLocalVersion(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.gerritforge.gerrit.plugins.multisite.validation.ProjectVersionRefUpdate#getProjectRemoteVersion(java.lang.String)
   */
  @Override
