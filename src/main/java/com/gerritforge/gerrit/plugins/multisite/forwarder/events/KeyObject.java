...
/**
 * Object used to encapsulate cache keys and their type so that when deserializing cache eviction
 * events we can be sure of their type.
 */
public class KeyObject {
  ...
  public static KeyObject wrap(Object key) {
