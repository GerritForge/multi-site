...
public abstract class AbstractSubcriber {
  ...
  @FunctionalInterface
  public interface RequeueAction<T> {

    void requeue(T t);

    RequeueAction<? extends Event> NO_ACTION = (e) -> {};
  }
  ...
  public AckAwareConsumer<Event> getManualAckConsumer(
      RequeueAction<? extends Event> requeueAction) {
  ...
  private void processRecord(
      ...
      boolean isAutoAck,
      AckMode ackMode,
      @Nullable RequeueAction<? extends Event> requeueAction) {
