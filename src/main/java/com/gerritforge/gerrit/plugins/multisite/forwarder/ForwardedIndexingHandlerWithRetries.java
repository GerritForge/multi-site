...
import com.gerritforge.gerrit.plugins.multisite.index.EntityChecker;
...
public abstract class ForwardedIndexingHandlerWithRetries<T, E extends IndexEvent>
  ...
  protected IndexingResult indexSyncIfConsistent(T id, E e, EntityChecker<T, E> entityChecker) {
    IndexingRetry retry =
