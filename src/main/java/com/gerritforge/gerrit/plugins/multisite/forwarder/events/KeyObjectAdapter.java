...
public class KeyObjectAdapter implements JsonSerializer<Object>, JsonDeserializer<Object> {
  ...
  @Override
  public JsonElement serialize(Object event, Type typeOfSrc, JsonSerializationContext context) {
    JsonElement elem = new Gson().toJsonTree(event);
    elem.getAsJsonObject().addProperty("key-type", event.getClass().getName());
    return elem;
  }
