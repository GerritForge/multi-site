...
@TestPlugin(
    name = "multi-site",
    sysModule =
        "com.gerritforge.gerrit.plugins.multisite.http.ReplicationStatusServletIT$TestModule",
    httpModule = "com.gerritforge.gerrit.plugins.multisite.http.HttpModule")
