...
public class MultiSiteConsumerRunnerTest {
  ...
  private static final String BROKER_PLUGIN_NAME = "a-broker-plugin";
  ...
  @Before
  public void setup() {
    brokerApiItem = DynamicItem.itemOf(BrokerApi.class, null);
  }
  ...
  private void bindBroker() {
    brokerApiItem.set(boundBrokerApi, BROKER_PLUGIN_NAME);
  }
}
