...
public class ForwardedIndexAccountHandlerTest {
  ...
  public void setUp() throws Exception {
    handler =
        new ForwardedIndexAccountHandler(
            indexerMock, accountChecker, indexExecutor, configuration, oneOffRequestContext);
    id = Account.id(123);
  }
  ...
  @Test
  public void shouldDeleteSynchronously() throws IOException {
    AccountIndexEvent event = new AccountIndexEvent(id.get(), null, "instance-id", true);
