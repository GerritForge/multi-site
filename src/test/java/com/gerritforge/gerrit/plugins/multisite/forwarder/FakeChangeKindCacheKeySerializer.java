...
@Ignore
public class FakeChangeKindCacheKeySerializer implements CacheSerializer<ChangeKindCacheImpl.Key> {
  ...
  public byte[] serialize(ChangeKindCacheImpl.Key object) {
    return String.join(
            SEPARATOR, object.prior().name(), object.next().name(), object.strategyName())
