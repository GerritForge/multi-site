...
public class AccountCheckerTest {
  ...
  public void setUp() throws Exception {
    ...
    checker = new AccountChecker(repoManager, ALL_USERS);
  }
  ...
  public void shouldAcceptLegacyEventWithoutRevision() {
    assertThat(checker.isUpToDate(Optional.of(new AccountIndexEvent(1, "instance-id")))).isTrue();
  }

  private Optional<AccountIndexEvent> event(RevCommit target) {
    return Optional.of(new AccountIndexEvent(ACCOUNT_ID.get(), target.name(), "instance-id"));
  }
}
