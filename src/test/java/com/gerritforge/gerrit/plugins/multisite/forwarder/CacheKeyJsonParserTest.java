...
public class CacheKeyJsonParserTest {
  ...
  public void serializeDeserializeCacheEvictionEventWithComplexKeyType() {
    ...
    Object parsedKey =
        gsonParser.from(GERRIT_PLUGIN_NAME, CACHE_NAME_WITH_COMPLEX_KEY_TYPE, jsonEvent);
  ...
  public void serializeDeserializeCacheEvictionEventForMultiplePlugins() {
    ...
    Object parsedKey1 = gsonParser.from(PLUGIN_NAME1, CACHE_NAME_WITH_COMPLEX_KEY_TYPE, jsonEvent1);
    Object parsedKey2 = gsonParser.from(PLUGIN_NAME2, CACHE_NAME_WITH_COMPLEX_KEY_TYPE, jsonEvent2);
  ...
  public void accountIDParse() {
    ...
    assertThat(accountId).isEqualTo(gsonParser.from(GERRIT_PLUGIN_NAME, Constants.ACCOUNTS, json));
  }
  ...
  public void accountGroupIDParse() {
    ...
    assertThat(accountGroupId)
        .isEqualTo(gsonParser.from(GERRIT_PLUGIN_NAME, Constants.GROUPS, json));
  }
  ...
  public void accountGroupUUIDParse() {
    ...
    assertThat(accountGroupUuid)
        .isEqualTo(gsonParser.from(GERRIT_PLUGIN_NAME, Constants.GROUPS_BYSUBGROUP, json));
  }
  ...
  public void projectNameKeyParse() {
    ...
    assertThat(projectNameKey)
        .isEqualTo(gsonParser.from(GERRIT_PLUGIN_NAME, Constants.PROJECTS, projectNameString));
  }
  ...
  public void stringParse() {
    String key = "key";
    assertThat(key)
        .isEqualTo(gsonParser.from(GERRIT_PLUGIN_NAME, CACHE_NAME_WITH_SIMPLE_KEY_TYPE, key));
  }
