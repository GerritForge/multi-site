...
public class CacheKeyJsonParserTest {
  ...
  public void accountGroupIDParse() {
    ...
    assertThat(accountGroupId).isEqualTo(gson.fromJson(json, AccountGroup.Id.class));
  }
  ...
  public void accountGroupUUIDParse() {
    ...
    assertThat(accountGroupUuid).isEqualTo(gson.fromJson(json, AccountGroup.UUID.class));
  }
