...
public class CacheKeyJsonParserTest {
  ...
  private DynamicMap<CacheDef<?, ?>> getDynamicMap() {
    ...
    CacheDef<AccountGroup.UUID, Object> groupsByIncludeTypeCacheDef =
        new TestCacheDef<>(Constants.GROUPS_BYINCLUDE, AccountGroup.UUID.class, Object.class);
    ...
    cacheDefMap.put("gerrit", Constants.GROUPS_BYINCLUDE, Providers.of(groupsByIncludeTypeCacheDef));
