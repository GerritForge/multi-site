...
public class FetchRefReplicatedEventHandlerTest {
  ...
  public void onEventShouldIgnoreMissingObjectWhenIndexExistingChangeMeta() {
    ...
    try {
      ...
      fetchRefReplicatedEventHandler.onEvent(
          newFetchRefReplicatedEvent(
              projectNameKey, ref, ReplicationState.RefFetchResult.SUCCEEDED, LOCAL_INSTANCE_ID, RefUpdate.Result.FAST_FORWARD));
      ...
      StorageException indexException =
          assertThrows(
              ...
              () ->
                  fetchRefReplicatedEventHandler.onEvent(
                      newFetchRefReplicatedEvent(
                          projectNameKey, ref, RefFetchResult.SUCCEEDED, LOCAL_INSTANCE_ID, RefUpdate.Result.FAST_FORWARD)));
