...
<<<<<<< PATCH SET (9b99cf5580574db1ebf2cee7f3d1d3d4fb595b7e Add 3rd site in the local test environment)
  file=$SCRIPT_DIR/configs/replication.remote
||||||| BASE      (100df93395bc3128eb63200eb353e05dc208fc84 Use fanout replication config for the local test environment)
  file=$SCRIPT_DIR/configs/replication.remote
  file_name=$REPLICA_INSTANCE_ID.config
=======
  fanout_template_file=$SCRIPT_DIR/configs/replication.remote
>>>>>>> BASE      (e6ca52bfda1cbd8b605b19c69792c3a014f3e16c Use fanout replication config for the local test environment)
...
GERRIT_3_SSHD_PORT=${GERRIT_3_SSHD_PORT:-"49419"}
